...
const HoldingBar = ({instrument="Instrument", qty="Qty", avgCost="Avg. cost", lpt="LPT", curVal="Cur. val", pnl="P&L", netChg="Net. chg", dayChg="Day. chg", data=false}) => {
  return (
    <div className="bar flex justify-between border-[#c8c8c8ac] border-b-1" style={{color: data ? "black" : ""}}>
      ...
      <span className="py-[1rem] w-[45%] border-[#c8c8c8ac] border-r flex justify-between px-[2rem] items-center">
        ...
        <span className="w-[24%] flex justify-center">
          <span className={(netChg>0 && data===true) ? "text-green-500" : "text-red-500"}>
            {pnl}
        </span>
        </span>
        ...
        <span className="w-[24%] flex justify-center">
          <span className={(dayChg>0 && data===true) ? "text-green-500" : "text-red-500"}>
            {dayChg}%
        </span>
        </span>
      </span>
